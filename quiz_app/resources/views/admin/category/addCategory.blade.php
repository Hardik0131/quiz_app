<div class="category-admin-nav">
    <div class="category_form">
        ...
        <form action="{{ route('admin.category.store') }}" method="POST" class="form" id="form">
            @csrf
            <div class="form_control">
                <label for="name">Category Name</label>
                <input type="text" name="name" id="name" placeholder="Enter your Category Name" autocomplete="off">
            </div>
            <div class="form_control">
                <label for="short_desc">Short Description</label>
                <input type="text" name="short_desc" id="short_desc" placeholder="Short Description Here..." autocomplete="off">
            </div>
            <div class="form_control">
